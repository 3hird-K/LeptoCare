  ...
  const html = `
    <html>
      <head>
        ...
        <style>
          body { padding: 16px; font-size: 16px; line-height: 1.5; }
      ...
      <body>
        ...
        <li>
        <p><strong>Application</strong> refers to Leptocare, the software program provided by the Company.</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Leptocare.</p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: dime.neil03@gmail.com</li>
        </ul>
      </body>
    </html>
  `;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          style={[
            styles.proceedBtn,
            { borderRadius: 10, margin: 10,backgroundColor: accepted ? '#4353Fd' : '#ccc' },
          ]}
          disabled={!accepted}
